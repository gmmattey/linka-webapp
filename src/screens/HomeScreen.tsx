  ...
  return (
    <AppScaffold>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
        <div aria-hidden="true" style={{ width: 28, height: 28, borderRadius: 99, background: 'var(--surface-2)', fontWeight: 700, fontSize: 12, display: 'grid', placeItems: 'center', color: 'var(--text)' }}>L</div>
        <div style={{ flex: 1 }}>
          <strong style={{ color: 'var(--text)', fontSize: 22, lineHeight: 1.15 }}>Olá, Lucas</strong>
          <p style={{ margin: 0, color: 'var(--text-2)', fontSize: 12 }}>Tudo funcionando bem!</p>
        </div>
      ...
      <StatusCard>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
          ...
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: 5, color: 'var(--success)', fontWeight: 600, fontSize: 12 }}><span style={{ width: 7, height: 7, borderRadius: '50%', background: 'var(--success)' }} />Online</span>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            <h3 style={{ margin: 0, color: 'var(--text)', fontSize: 18, lineHeight: 1.1 }}>Casa_5G</h3>
            <p style={{ margin: '2px 0 6px', color: 'var(--text-2)', fontSize: 12 }}>Conectado · 5 GHz</p>
      ...
      <StatusCard>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
          ...
          <small style={{ color: 'var(--text-2)', fontSize: 11 }}>Hoje, 09:28</small>
        </div>
      ...
      <StatusCard>
        <strong style={{ color: 'var(--text)', fontSize: 16, display: 'block', marginBottom: 8 }}>Ações rápidas</strong>
