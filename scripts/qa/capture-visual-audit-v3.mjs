...
const out = path.join(root, 'docs', 'visual-audit', 'screenshots-v3');
fs.mkdirSync(out, { recursive: true });

const files = {
  home: 'home-v3.png',
  velocidade: 'velocidade-v3.png',
  running: 'running-v3.png',
  resultado: 'resultado-v3.png',
  sinal: 'sinal-v3.png',
  dispositivos: 'dispositivos-v3.png',
  historico: 'historico-v3.png',
  ajustes: 'ajustes-v3.png',
};
